package com.booklibrary.notificationservice.event;

import com.booklibrary.commonservice.service.EmailService;
...
public class EventConsumer {
    ...
    public void listen(String message) {
        log.info("Received Message in: " + message);
//        throw new RuntimeException("Error test");
    ...
    public void testEmail(String message){
        ...
        String template = "<div>\n" +
                ...
                "</div>";
        String filledTemplate = String.format(template,"Phan Anh Duc",message);
